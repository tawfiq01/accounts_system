...
<head>
    ...
    <title>{{(\App\Models\Utility::getValByName('title_text')) ? \App\Models\Utility::getValByName('title_text') : config('app.name', 'AccountGo SaaS')}}  @yield('page-title')</title>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-sm-12 text-end">
                <p class="text-body">{{(\App\Models\Utility::getValByName('footer_text')) ? \App\Models\Utility::getValByName('footer_text') :  __('Copyright AccountGo SaaS') }} {{ date('Y') }}</p>
            </div>
        </div>
    </div>
</section>
